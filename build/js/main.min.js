...
/*!******************************!*\
  !*** ./js/custom/cruises.js ***!
  \******************************/
/*! exports provided: CRUISES */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CRUISES", function() { return CRUISES; });
var CRUISES = [{
  name: 'Астория',
...
var cruiseTemplate = document.querySelector('#cruise').content.querySelector('[data-item="cruise"]');
var cruisesList = document.querySelector('[data-list="offers"]');
var createItem = function createItem(cruise) {
  var cruiseNode = cruiseTemplate.cloneNode(true);
  cruiseNode.querySelector('[data-value="title"]').innerText = "\u041A\u0440\u0443\u0438\u0437 \"".concat(cruise.name, "\"");
  ...
  cruiseNode.querySelector('[data-value="duration"]').innerText = cruise.duration;
  cruiseNode.querySelector('[data-value="price"]').innerText = cruise.price;
  cruisesList.appendChild(cruiseNode);
  cruiseNode.querySelector('[data-img="source"]').setAttribute('srcset', "/img/cruises/".concat(cruise.img, ".webp 1x, /img/cruises/").concat(cruise.img, "@2x.webp 2x"));
  cruiseNode.querySelector('[data-img="img"]').setAttribute('src', "/img/cruises/".concat(cruise.img, ".jpg"));
  cruiseNode.querySelector('[data-img="img"]').setAttribute('srcset', "/img/cruises/".concat(cruise.img, "@2x.jpg 2x"));
  return cruiseNode;
};
var createList = function createList(list) {
  list.map(function (cruise) {
...
/*!***************************************!*\
  !*** ./js/custom/toogleIconChange.js ***!
  \***************************************/
/*! exports provided: changeIcon */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "changeIcon", function() { return changeIcon; });
var toggleIcon = document.querySelector('[data-icon="checkbox"]');
var checkbox = document.querySelector('[data-input="checkbox"]');
...
/* harmony import */ var _custom_drawCruises__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./custom/drawCruises */ "./js/custom/drawCruises.js");
/* harmony import */ var _custom_cruises__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./custom/cruises */ "./js/custom/cruises.js");
/* harmony import */ var _custom_toogleIconChange__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./custom/toogleIconChange */ "./js/custom/toogleIconChange.js");
/* harmony import */ var _modules_header_burger__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/header/burger */ "./js/modules/header/burger.js");
/* harmony import */ var _modules_header_sticky_header__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/header/sticky-header */ "./js/modules/header/sticky-header.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    Object(_custom_toogleIconChange__WEBPACK_IMPORTED_MODULE_5__["changeIcon"])();
    Object(_custom_drawCruises__WEBPACK_IMPORTED_MODULE_3__["createList"])(_custom_cruises__WEBPACK_IMPORTED_MODULE_4__["CRUISES"]);
    ...
    window.form = form;
    form.init();
    var burger = new _modules_header_burger__WEBPACK_IMPORTED_MODULE_6__["Burger"]();
    burger.init();
  });
});
