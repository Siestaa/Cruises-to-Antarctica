...
/* harmony import */ var _custom_toogleIconChange__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./custom/toogleIconChange */ "./js/custom/toogleIconChange.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    Object(_custom_toogleIconChange__WEBPACK_IMPORTED_MODULE_3__["changeIcon"])();
  ...
  _createClass(Form, [{
    ...
    value: function _onFormSubmit(event) {
      ...
      if (this.validateForm(event.target) && callback) {
        ...
        setTimeout(function () {
          return document.querySelector('.form-succes').classList.remove('form-succes--view');
        }, 2000);
