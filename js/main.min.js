...
/*!******************************!*\
  !*** ./js/custom/cruises.js ***!
  \******************************/
/*! exports provided: CRUISES */function(e,t,n){"use strict";n.r(t),n.d(t,"CRUISES",(function(){return i}));var i=[{name:"Астория",way:"Аргентина - Фолклендские острова - Антарктида",port:"Ушуайя",duration:"11 дней",price:"от 11500 $",img:"astoria"},{name:"Элайн",way:"Аргентина - Фолклендские острова - Антарктида - Чили",port:"Буэнос-Айрес",duration:"20 дней",price:"от 14500 $",img:"aline"},{name:"Атлантис",way:"Аргентина - Южная Георгия и Южные Сандвичевы Острова - Антарктида",port:"Ушуайя",duration:"15 дней",price:"от 14500 $",img:"atlantis"},{name:"Одиссей",way:"Чили - Антарктида",port:"Пунта-Аренас",duration:"13 дней",price:"от 9700 $",img:"odisey"},{name:"Олимпия",way:"Аргентина - Фолклендские острова - Южная Георгия - Антарктида",port:"Ушуайя",duration:"21 дней",price:"от 18600 $",img:"olimpiya"},{name:"Аврора",way:"Аргентина - Антарктида - Чили",port:"Ушуайя",duration:"14 дней",price:"от 11700 $",img:"avrora"},{name:"Леонор",way:"Чили - Южная Георгия - Антарктида - Аргентина",port:"Пунта-Аренас",duration:"17 дней",price:"от 12500 $",img:"leonor"},{name:"Минион - 1",way:"Аргентина - Антарктида",port:"Ушуайя",duration:"11 дней",price:"от 12300 $",img:"minion"}]},"./js/custom/drawCruises.js":
/*!**********************************!*\
  !*** ./js/custom/drawCruises.js ***!
  \**********************************/
/*! exports provided: createList */function(e,t,n){"use strict";n.r(t),n.d(t,"createList",(function(){return r}));var i=document.querySelector("#cruise"),o=document.querySelector('[data-list="offers"]'),r=function(e){i&&e.map((function(e){o.appendChild(function(e){var t=i.content.querySelector('[data-item="cruise"]').cloneNode(!0);return t.querySelector('[data-value="title"]').innerText='Круиз "'.concat(e.name,'"'),t.querySelector('[data-value="way"]').innerText=e.way,t.querySelector('[data-value="port"]').innerText=e.port,t.querySelector('[data-value="duration"]').innerText=e.duration,t.querySelector('[data-value="price"]').innerText=e.price,o.appendChild(t),t.querySelector('[data-img="source"]').setAttribute("srcset","./img/cruises/".concat(e.img,".webp 1x, ./img/cruises/").concat(e.img,"@2x.webp 2x")),t.querySelector('[data-img="img"]').setAttribute("src","./img/cruises/".concat(e.img,".jpg")),t.querySelector('[data-img="img"]').setAttribute("srcset","./img/cruises/".concat(e.img,"@2x.jpg 2x")),t}(e))}))}},"./js/custom/toogleIconChange.js":
/*!***************************************!*\
  !*** ./js/custom/toogleIconChange.js ***!
  \***************************************/
/*! exports provided: changeIcon */function(e,t,n){"use strict";n.r(t),n.d(t,"changeIcon",(function(){return s}));var i=document.querySelector('[data-icon="checkbox"]'),o=document.querySelector('[data-input="checkbox"]'),r=function(){o.checked?i.classList.remove("book__checkbox-icon--hide"):i.classList.add("book__checkbox-icon--hide")},s=function(){i&&o.addEventListener("change",r)}},"./js/main.js":
/*!********************!*\
  !*** ./js/main.js ***!
  \********************/
/*! no exports provided */function(e,t,n){"use strict";n.r(t);var i=n(/*! ./utils/ios-vh-fix */"./js/utils/ios-vh-fix.js"),o=n(/*! ./modules/modals/init-modals */"./js/modules/modals/init-modals.js"),r=n(/*! ./modules/form-validate/form */"./js/modules/form-validate/form.js"),s=n(/*! ./custom/drawCruises */"./js/custom/drawCruises.js"),a=n(/*! ./custom/cruises */"./js/custom/cruises.js"),l=n(/*! ./custom/toogleIconChange */"./js/custom/toogleIconChange.js"),c=n(/*! ./modules/header/burger */"./js/modules/header/burger.js");n(/*! ./modules/header/sticky-header */"./js/modules/header/sticky-header.js");window.addEventListener("DOMContentLoaded",(function(){Object(i.iosVhFix)(),window.addEventListener("load",(function(){Object(l.changeIcon)(),Object(s.createList)(a.CRUISES),Object(o.initModals)();var e=new r.Form;window.form=e,e.init(),(new c.Burger).init()}))}))},"./js/modules/form-validate/callback.js":
/*!**********************************************!*\
